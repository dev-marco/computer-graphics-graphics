...
namespace Geometry {
    ...
    public:
        ...
        Cylinder (const Vec<3> &_bottom, const Vec<3> &_top, float_t _radius) :
        ...
        inline float_t getHeight (void) const { return this->height; }
        ...
        inline void setRadius (float_t _radius) { this->radius = _radius; }
